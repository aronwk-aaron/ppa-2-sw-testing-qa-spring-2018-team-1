...
# calc_bmi(f,i,p) takes in 3 integers (feet, inches, pounds) and calculates BMI based on input.
# Returns tuple with the form ("category", bmi), where category is a string and bmi is your numerical bmi
